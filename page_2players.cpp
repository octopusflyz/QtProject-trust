#include "page_2players.h"
#include "ui_page_2players.h"
#include<QTimer>
#include<QDebug>
#include<QPainter>

page_2players::page_2players(QWidget *parent)
    : QWidget(parent)
    , ui(new Ui::page_2players)
{
    ui->setupUi(this);
...
void page_2players::paintEvent(QPaintEvent *event){
    //qDebug()<<flag;
